...
int text_to_speech(const char* src_text, const char* des_path, const char* params)
{
	...
	wave_pcm_hdr wav_hdr      = default_wav_hdr2;
	...
	while (1) 
	{
		...
		//comment when using offline...
		// printf(">");
		// usleep(150*100); //防止频繁占用CPU
	}
	printf("\n");
	if (MSP_SUCCESS != ret)
	{
...
int SpeechSynthesis(const char* text2speech)
{
	...
	* purextts
	*/
	const char* session_begin_params = "engine_type = cloud,voice_name=xiaoyan, text_encoding = UTF8, tts_res_path = fo|/home/kevin/intelligentvoiceordering/demo_aiui_iat_tts/bin/msc/res/tts/xiaoyan.jet;fo|/home/kevin/intelligentvoiceordering/demo_aiui_iat_tts/bin/msc/res/tts/common.jet, sample_rate = 16000, speed = 60, volume = 50, pitch = 50, rdn = 2";	
